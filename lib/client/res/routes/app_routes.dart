  ...
  static List<GetPage> pages() {
    return [
      ...
      GetPage(
        ...
        page: () => const LoginPageClient(),
      ),
      GetPage(
        name: RoutesName.signUp,
        page: () => const SignUpPageClient(),
      ),
      GetPage(
        name: RoutesName.home,
        page: () => HomeScreenClient(),
      ),
      GetPage(
        name: RoutesName.registerFir,
        page: () => const RegisterFIR(),
      ),
      GetPage(
        name: RoutesName.completeAccount,
        page: () => const CompleteRegistrationPage(),
      ),
      GetPage(
        name: RoutesName.investigationUpdate,
        page: () => const InvestigationDetailsPage(),
      ),
      GetPage(
